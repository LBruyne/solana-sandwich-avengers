...
Inputs : sandwich-intent/data/1_signer_data_preparation_and_summary/<cat>/signer_features_946_960.parquet
Outputs:
  sandwich-intent/data/sec5_2/wr_distribution_946_960.pdf
...
SRC_BASE = REPO / "sandwich-intent" / "data" / "1_signer_data_preparation_and_summary"
OUT_DIR = REPO / "sandwich-intent" / "data" / "sec5_2"
